...
const HomePrinciples = () => {
  return (
    <section className="bg-[#EAF3E7] px-5 py-24 md:px-10 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <p className="mb-4 text-xs uppercase tracking-[0.32em] text-[#4D8D83]">
            Our point of view
          </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {principles.map((item, index) => (
            <article
              key={item.title}
              className="min-h-[230px] bg-[#FFFDF8] p-7 shadow-[0_14px_50px_rgba(23,23,21,0.06)]"
            >
              <p className="mb-8 text-xs uppercase tracking-[0.26em] text-[#68B7AA]">
                0{index + 1}
              </p>
              ...
              <p className="mt-5 text-sm leading-7 text-[#171715]/70">
                {item.text}
              </p>
            </article>
          ))}

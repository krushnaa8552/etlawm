...
const GLOBAL_STYLES = `
  @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;600&family=Josefin+Sans:wght@100;300;400;600&display=swap');
                ...
                {[
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.background = "rgba(250,248,244,0.1)";
                    }}
                    onMouseLeave={(e) => {
